...
def parse_opt():
    ...
    parser.add_argument('--weights', nargs='+', type=str, default=ROOT / '20240829.pt', help='model.pt path(s)')
    ...
    parser.add_argument('--conf-thres', type=float, default=0.3, help='TF.js NMS: confidence threshold')
